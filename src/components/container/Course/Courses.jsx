  ...
  return (
    <div className="section" id="courses">
      <div className="text-center">
        ...
        <p
          className="text-sm text-gray leading-7 max-w-[700px]
        mx-auto"
        >
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Odit, quae?
          Veritatis cum vel possimus quas natus? Accusamus commodi aperiam quam,
          voluptatem ullam placeat mollitia ipsa eos quos repellendus provident
          nam.
        </p>
      </div>
      ...
      <div className="mt-12 overflow-x-hidden w-full relative">
        <div
          className="flex gap-8 md:w-full sm:w-[170%]
